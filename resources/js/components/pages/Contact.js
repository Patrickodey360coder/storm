              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-11 mx-auto">
                <form onSubmit={handleSubmit(onSubmit)} noValidate>
                  <div className="mb-3">
                    ...
                    {errors.name && <small className="px-2 text-danger"> {errors.name.message}</small>}
                  </div>
                  <div className="mb-3">
                    ...
                    {errors.email && <small className="px-2 text-danger"> {errors.email.message}</small>}
                  </div>
                  <div class="mb-3">
                    ...
                    {errors.message && <small className="px-2 text-danger"> {errors.message.message}</small>}
                  </div>
